  ...
  return (
    <SectionLayout>
      <S.FeaturesWrapper>
        ...
        <S.FeaturesSubtitle>
          Explorez notre collection exquise de Discus élevés dans nos aquariums
          et choyés au quotidien, ainsi qu&apos;une variété d&apos;autres
          produits aquariophiles exceptionnels. Chez Planète Discus, nous sommes
          fiers de vous offrir des poissons d&apos;une beauté exceptionnelle et
          d&apos;une santé éclatante, tout en proposant une gamme complète
        ...
        <S.FeaturesList>
          <S.FeaturesItem>
            ...
            <S.FeaturesItemDescription>
              ...
              avec une attention minutieuse portée à chaque détail et chaque
              étape du processus.
            </S.FeaturesItemDescription>
          </S.FeaturesItem>
          <S.FeaturesItem>
